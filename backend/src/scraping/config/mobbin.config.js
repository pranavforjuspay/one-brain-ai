...
exports.FALLBACK_SELECTORS = exports.SEARCH_PATTERNS = exports.CATEGORY_SELECTORS = exports.PLATFORM_WORKFLOWS = exports.MOBBIN_CONFIG = exports.MOBBIN_SELECTORS = void 0;
/**
 * Comprehensive Mobbin selectors for all search paths
 */
exports.MOBBIN_SELECTORS = {
...
exports.MOBBIN_CONFIG = {
    ...
    workflows: {
        ...
        // Phase 1: Apps iOS - Multi-app exploration with reliable navigation
        appsIosMultiExploration: [
            ...
            {
                action: 'waitFor',
                selector: 'text={{firstApp}}, text={{secondApp}}, text={{thirdApp}}',
                description: 'Wait for multiple app suggestions to appear',
                timeout: 3000
            },
            {
                action: 'click',
                selector: 'text={{firstApp}}',
                description: 'Click first app suggestion',
                retryCount: 2
            },
            {
                action: 'waitFor',
                selector: '.design-card, .app-screens, .screen-result',
            ...
            },
            {
                action: 'navigate',
                value: 'https://mobbin.com',
                description: 'Navigate back to homepage for next app',
                timeout: 5000
            },
            {
                action: 'click',
                selector: 'text=Search on iOS...',
                description: 'Re-open iOS search modal',
                retryCount: 2
            },
            {
                action: 'fill',
                selector: 'input[type="text"]',
                value: '{{keyword}}',
                description: 'Re-type keyword to trigger app suggestions'
            },
            {
                action: 'waitFor',
                selector: 'text={{secondApp}}',
                description: 'Wait for app suggestions to appear again',
                timeout: 3000
            },
            {
                action: 'click',
                selector: 'text={{secondApp}}',
                description: 'Click second app suggestion',
                retryCount: 2
            },
            {
                action: 'waitFor',
                selector: '.design-card, .app-screens, .screen-result',
                description: 'Wait for second app page to load',
                timeout: 8000
            },
            {
                action: 'navigate',
            ...
            },
            {
                action: 'click',
                selector: 'text=Search on iOS...',
                description: 'Re-open iOS search modal for third app',
                retryCount: 2
            },
            {
                action: 'fill',
                selector: 'input[type="text"]',
                value: '{{keyword}}',
                description: 'Re-type keyword for third app'
            },
            {
                action: 'waitFor',
                selector: 'text={{thirdApp}}',
                description: 'Wait for app suggestions for third app',
                timeout: 3000
            },
            {
                action: 'click',
                selector: 'text={{thirdApp}}',
                description: 'Click third app suggestion',
                retryCount: 2
            },
            {
                action: 'waitFor',
                selector: '.design-card, .app-screens, .screen-result',
                description: 'Wait for third app page to load',
                timeout: 8000
            }
        ],
